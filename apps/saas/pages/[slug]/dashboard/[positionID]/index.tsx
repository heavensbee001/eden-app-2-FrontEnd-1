    ...
    <>
      ...
      <div className="mx-auto max-w-screen-2xl flex-grow p-8">
        <div className="z-20 w-full transition-all duration-200 ease-in-out">
          ...
          <div className="">
            <h2 className="text-edenGreen-600 mb-5">
              All candidates
              <span className="font-Unica text-edenGreen-500 -mt-2 ml-2 inline-block text-xs font-normal">{`(${candidatesFromTalentList.length})`}</span>
            </h2>
            <CandidatesTableList
