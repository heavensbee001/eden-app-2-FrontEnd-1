...
const HomePage: NextPageWithLayout = ({ slug }) => {
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  debugger;
  const hasSubdomain = isSubdomain(ctx.req?.headers.host!);

  let slug = null;

  if (hasSubdomain) {
    slug = ctx.req?.headers.host?.split(".")[0];
  }
...
var isSubdomain = function (url: string) {
