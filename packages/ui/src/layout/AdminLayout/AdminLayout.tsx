        ...
        <>
          <div>
            ...
            <div className="flex flex-1 flex-col md:pl-64">
              <div className="sticky top-0 z-20 flex h-16 border-b bg-white pl-1 pt-1 shadow-lg shadow-slate-500/10 sm:pl-3 sm:pt-3 md:hidden">
                <button
                  type="button"
              ...
              <div
                className={`sticky top-0 z-20 hidden h-16 justify-between border-b bg-white md:flex `}
              >
                <div></div>
